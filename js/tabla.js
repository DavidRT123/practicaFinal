...
templates['tabla'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "	    			<tr data-id=\""
    ...
    + "\">\r\n						<td class='ui mobile only bold'>Nombre: </td><td>"
    ...
    + "</td>\r\n						<td class='ui mobile only bold'>Ciudad: </td><td>"
    ...
    + "</td>\r\n						<td class='ui mobile only bold'>Sexo: </td><td>"
    ...
    + "</td>\r\n						<td class='ui mobile only bold'>Teléfono: </td><td>"
    ...
    + "</td>\r\n						<td class='ui mobile only bold'>Fecha de nacimiento: </td><td>"
